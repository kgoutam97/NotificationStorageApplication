...
//	private NotificationRepository notificationRepository;
	...
	public List<NotificationResponse> findAllNotification() {
		...
		System.out.println("user Repository findAllUsers");
	...
	public void addNotification(NotificationEntity notificationEntity) {
		try {
			...
			jdbcTemplate.update(query, notificationEntity.getNotificationType(), notificationEntity.getUser(),
			...
			System.out.println("Notification is created Is created");
		} catch (Exception e) {
		}
	}
	...
	public boolean isNotificationExist(int notificationId) {
		try {
			...
			int count = jdbcTemplate.queryForObject(sql, new Object[] { notificationId }, Integer.class);
			if (count > 0)
				return true;
			return false;
		} catch (Exception e) {
